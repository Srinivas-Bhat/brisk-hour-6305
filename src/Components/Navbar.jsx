  ...
  return (
    <div className="Navbar-Container">
      <div className="header-sec">
        <div className="head_locator_wrapper">
          <div className="header_store_locator">
            <Flex justify="center" align="center" gap="10px" className="store_locator_flex">
          ...
          <div className="hamburger-menu" ref={btnRef} onClick={onOpen}><MenuOutlinedIcon/></div>
      ...
      <div className="dropdown_section_wrapper">
        ...
        <Heading as="h3" variant="h4" className="drophead">BRANDS</Heading>
          <div className="dropdown-content3"></div>
        </div>
        <div className="hover-dropdown4">
        <Heading as="h3" variant="h4" className="drophead">EXPLORE</Heading>
          <div className="dropdown-content4"></div>
        </div>
        <div className="hover-dropdown5">
        <Heading as="h3" variant="h4" className="drophead">EVENTS</Heading>
          <div className="dropdown-content5"></div>
        </div>
        <div className="hover-dropdown6">
        <Heading as="h3" variant="h4" className="drophead">BLUEREWARDS</Heading>
          <div className="dropdown-content6"></div>
        </div>
        <div className="hover-dropdown7">
        <Heading as="h3" variant="h4" className="drophead">BEAUTY ALFRESCO</Heading>
